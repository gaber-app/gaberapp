  ...
  return (
    <section id="what-is-gaber" ref={sectionRef} className="relative py-16 md:py-20 lg:py-24 px-4 md:px-6 lg:px-16">
      <div className="w-full mx-auto">
        ...
        <div ref={contentRef} className="max-w-2xl text-left mb-12">
          <p className="text-lg font-medium leading-relaxed text-foreground sm:text-xl">
            Gaber (Կապեր) is the premier professional networking app designed exclusively for the US-based Armenian
            diaspora. Our mission is to strengthen the Armenian community in the United States by providing a dedicated
            digital space for professional connection. Learn more about{" "}
            <button
        ...
        <div ref={cardsRef} className="grid grid-cols-1 gap-6 md:grid-cols-3 w-full">
          ...
          <Card className="border-border/50 bg-card/50 backdrop-blur-sm">
            <CardContent className="p-6">
              ...
              <p className="text-sm text-muted-foreground">
                A welcoming and safe space for all Armenians, regardless of career stage.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-border/50 bg-card/50 backdrop-blur-sm">
            <CardContent className="p-6">
              ...
              <p className="text-sm text-muted-foreground">
                Network and connections to help you grow personally and professionally.
              </p>
            </CardContent>
          </Card>
        </div>
